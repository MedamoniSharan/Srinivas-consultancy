import { ArrowUpRight, Smartphone, Code, Globe, Check, Brain, Briefcase } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Native iOS applications built with Swift and SwiftUI, optimized for performance and aligned with Apple's design guidelines.",
    },
    {
      icon: <Smartphone size={22} />,
      title: "Android Development",
      desc: "High-performance native Android apps using Kotlin and Jetpack Compose, designed for the full range of Android devices.",
    },
    {
      icon: <Code size={22} />,
      title: "Cross-Platform",
      desc: "Cost-effective cross-platform development with React Native and Flutter — one codebase, multiple platforms, native feel.",
    },
    {
      icon: <Brain size={22} />,
      title: "UI/UX Design",
      desc: "User-centered mobile design with intuitive navigation, beautiful interfaces, and interaction patterns users love.",
    },
    {
      icon: <Check size={22} />,
      title: "App Maintenance",
      desc: "Ongoing maintenance, OS updates, bug fixes, and feature enhancements to keep your app running smoothly post-launch.",
    },
    {
      icon: <Globe size={22} />,
      title: "Performance Optimization",
      desc: "App profiling, memory optimization, and rendering improvements to deliver smooth, responsive experiences on every device.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">Mobile App Development</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Native and cross-platform mobile applications with exceptional UI/UX, built for performance and scalability on iOS and Android.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's build a mobile app your users will love."}</p>
