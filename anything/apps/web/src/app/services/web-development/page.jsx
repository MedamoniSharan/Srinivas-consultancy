...
const bentoItems = [
  ...
  { title: "Responsive Design", desc: "Pixel-perfect layouts that adapt flawlessly across all devices.", icon: <MonitorSmartphone size={24} /> },
  { title: "E-Commerce", desc: "Scalable online stores with secure payments and inventory management.", icon: <ShoppingCart size={24} /> },
  { title: "CMS Integration", desc: "Headless CMS setups for easy content management by your team.", icon: <FileCode2 size={24} /> },
  { title: "API Development", desc: "RESTful and GraphQL APIs designed for reliability and speed.", icon: <Plug size={24} /> },
  { title: "Performance Optimization", desc: "Core Web Vitals tuning, CDN strategies, caching, and server-side rendering for blazing-fast load times.", large: true, image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format&fit=crop" },
];

const steps = [
  { num: "01", title: "Strategy", desc: "Define goals, tech stack, architecture, and success metrics." },
  { num: "02", title: "Design", desc: "Wireframes, prototypes, and visual design with your brand." },
  { num: "03", title: "Develop", desc: "Agile development with CI/CD and continuous feedback." },
  { num: "04", title: "Deploy", desc: "Cloud deployment, monitoring, and ongoing iteration." },
];
      ...
      <section className="relative pt-36 pb-24 px-6 text-center overflow-hidden">
        ...
        <AnimatedSection>
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Blazing-fast, beautifully crafted web applications — from responsive marketing sites to complex full-stack platforms.
          </p>
        </AnimatedSection>
      </section>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <AnimatedSection>
          <div className="relative rounded-2xl overflow-hidden">
            <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1200&q=80&auto=format&fit=crop" alt="Web development showcase" className="w-full h-[400px] object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
            <div className="absolute bottom-0 left-0 p-8 md:p-12 max-w-2xl">
              <p className="text-xl md:text-2xl font-semibold text-white leading-relaxed italic">
                &ldquo;They rebuilt our platform from scratch — page load dropped from 8s to under 1s. Conversions doubled within a month.&rdquo;
              </p>
              <p className="text-[#a855f7] text-sm mt-4 font-medium">— Head of Product, E-Commerce Brand</p>
            </div>
          </div>
        </AnimatedSection>
      </section>
      ...
      <section className="py-24 px-6">
        <AnimatedSection>
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#a855f7]/20 via-zinc-900 to-black rounded-3xl border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Launch Your Next Web Project</h2>
            <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">Modern, fast, and built to scale — let&apos;s make it happen.</p>
