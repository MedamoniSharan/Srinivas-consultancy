import { ArrowUpRight, Globe, Code, Briefcase, Check, Brain, ShoppingCart } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Modern, responsive interfaces built with React, Next.js, and Vue — pixel-perfect designs with blazing-fast performance.",
    },
    {
      icon: <Globe size={22} />,
      title: "Backend Development",
      desc: "Robust server-side architectures using Node.js, Python, and Java with RESTful APIs, microservices, and event-driven systems.",
    },
    {
      icon: <ShoppingCart size={22} />,
      title: "E-Commerce",
      desc: "Full-featured online stores with secure payments, inventory management, and conversion-optimized checkout experiences.",
    },
    {
      icon: <Briefcase size={22} />,
      title: "CMS Solutions",
      desc: "Custom content management systems and headless CMS integrations that give your team full control over content workflows.",
    },
    {
      icon: <Brain size={22} />,
      title: "API Development",
      desc: "Well-documented REST and GraphQL APIs designed for reliability, security, and seamless third-party integration.",
    },
    {
      icon: <Check size={22} />,
      title: "Cloud Deployment",
      desc: "Production-ready cloud infrastructure on AWS, Azure, or GCP with CI/CD pipelines, auto-scaling, and monitoring.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">Web Development</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Modern, responsive web applications — from frontend interfaces and e-commerce to complex backend systems and cloud-native APIs.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's build a web application that drives results."}</p>
