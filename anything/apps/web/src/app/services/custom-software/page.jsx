import { ArrowUpRight, Code, Check, Globe, Brain, Briefcase, Building2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Deep-dive discovery sessions to understand your business processes, pain points, and objectives before writing a single line of code.",
    },
    {
      icon: <Building2 size={22} />,
      title: "Architecture Design",
      desc: "Scalable, maintainable system architectures designed for your specific needs — microservices, monoliths, or serverless.",
    },
    {
      icon: <Code size={22} />,
      title: "Agile Development",
      desc: "Iterative development with sprint-based delivery, continuous feedback loops, and transparent progress tracking.",
    },
    {
      icon: <Check size={22} />,
      title: "Quality Assurance",
      desc: "Comprehensive testing — unit, integration, E2E, performance, and security testing to ensure production-grade reliability.",
    },
    {
      icon: <Globe size={22} />,
      title: "DevOps",
      desc: "CI/CD pipelines, infrastructure as code, containerization, and automated deployments for rapid, reliable releases.",
    },
    {
      icon: <Briefcase size={22} />,
      title: "Maintenance & Support",
      desc: "Ongoing post-launch support with SLA-backed response times, proactive monitoring, and continuous improvement cycles.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">Custom Software Development</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Bespoke software solutions tailored to your unique business requirements, built with agile methodology and rigorous quality assurance.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's build custom software that gives you a competitive edge."}</p>
