import { ArrowUpRight, Users, Brain, Smartphone, Globe, Code } from "lucide-react";

export default function ServicesPage() {
  const services = [
    {
      title: "IT Staffing & Consulting",
      desc: "Access top-tier tech talent through our extensive network. From contract staffing to permanent placement, we find the right people for your team.",
      icon: <Users size={24} />,
      href: "/services/staffing",
    },
    {
      title: "AI Development",
      desc: "Custom AI and machine learning solutions — from predictive analytics and NLP to computer vision and intelligent automation.",
      icon: <Brain size={24} />,
      href: "/services/ai-development",
    },
    {
      title: "Mobile App Development",
      desc: "Native and cross-platform mobile applications with exceptional UI/UX, built for performance and scalability.",
      icon: <Smartphone size={24} />,
      href: "/services/mobile-development",
    },
    {
      title: "Web Development",
      desc: "Modern, responsive web applications — from frontend interfaces and e-commerce to complex backend systems and APIs.",
      icon: <Globe size={24} />,
      href: "/services/web-development",
    },
    {
      title: "Custom Software Development",
      desc: "Bespoke software solutions tailored to your unique business requirements, built with agile methodology and quality assurance.",
      icon: <Code size={24} />,
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-[#a855f7] mb-6">Our Services</div>
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">Services</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          End-to-end technology services to design, build, and scale digital solutions that drive real business impact.
        </p>
      </section>
