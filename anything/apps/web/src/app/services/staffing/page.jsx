import { ArrowUpRight, Users, Briefcase, Check, Globe, Brain, Code } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Access our extensive network of vetted technology professionals across all major disciplines, stacks, and seniority levels.",
    },
    {
      icon: <Code size={22} />,
      title: "Technical Screening",
      desc: "Rigorous multi-stage technical assessments including coding challenges, system design interviews, and culture fit evaluations.",
    },
    {
      icon: <Briefcase size={22} />,
      title: "Contract Staffing",
      desc: "Flexible contract engagements for project-based needs — scale your team up or down without long-term commitments.",
    },
    {
      icon: <Check size={22} />,
      title: "Permanent Placement",
      desc: "Find the perfect full-time hires with our thorough matching process that considers skills, experience, and team dynamics.",
    },
    {
      icon: <Brain size={22} />,
      title: "Team Augmentation",
      desc: "Seamlessly embed skilled engineers into your existing teams to accelerate delivery and bridge capability gaps.",
    },
    {
      icon: <Globe size={22} />,
      title: "Onboarding Support",
      desc: "Comprehensive onboarding assistance to ensure new team members integrate smoothly and become productive from day one.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-[#a855f7] mb-6">Service</div>
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">IT Staffing & Consulting</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Access top-tier technology talent through our extensive network. From contract staffing to permanent placement, we find the right people for your team.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's find the right talent to power your next project."}</p>
