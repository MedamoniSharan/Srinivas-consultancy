...
const responsibilities = [
  "Design, develop, and deploy production-grade machine learning models for classification, regression, and recommendation systems",
  "Build and optimize NLP pipelines for text extraction, sentiment analysis, and conversational AI applications",
  "Develop computer vision solutions for image recognition, object detection, and video analytics",
  "Collaborate with data engineers to build robust feature engineering and data preprocessing pipelines",
  "Deploy and monitor ML models using MLOps best practices with CI/CD pipelines and model versioning",
  "Stay current with emerging AI research and evaluate new techniques for practical business applications",
];
...
const requirements = [
  ...
  "Solid understanding of statistics, linear algebra, and algorithm design",
];
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">AI/ML Engineer</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="mb-12">
          ...
          <p className="text-gray-400 leading-relaxed">
            We are looking for a talented AI/ML Engineer to join our growing team at Srinivas Consultancy. In this role, you will design and build intelligent systems that power our products and client solutions. You&apos;ll work across the full ML lifecycle — from data exploration and model development to production deployment and monitoring. This is an opportunity to solve real-world problems using cutting-edge AI technologies in a collaborative, fast-paced environment.
          </p>
        </div>
        ...
        <div className="text-center bg-zinc-900/50 border border-white/5 rounded-3xl p-10">
          ...
          <p className="text-gray-400 mb-6">Send us your resume and let&apos;s build the future of AI together.</p>
