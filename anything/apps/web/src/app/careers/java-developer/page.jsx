...
const responsibilities = [
  "Design and develop enterprise-grade applications using Java, Spring Boot, and Spring Cloud frameworks",
  "Build and maintain microservices architecture with RESTful APIs, message queues, and service discovery",
  "Design and optimize relational databases (PostgreSQL, MySQL) and implement ORM with Hibernate/JPA",
  "Implement CI/CD pipelines using Jenkins, GitHub Actions, or GitLab CI for automated testing and deployment",
  "Write clean, testable code with comprehensive unit and integration tests using JUnit and Mockito",
  "Collaborate with cross-functional teams to translate business requirements into scalable technical solutions",
];

const requirements = [
  "3+ years of professional experience in Java development with Spring Boot and Spring ecosystem",
  "Strong knowledge of microservices patterns, REST API design, and distributed system concepts",
  "Experience with relational databases, SQL optimization, and ORM frameworks (Hibernate/JPA)",
  "Familiarity with containerization (Docker), orchestration (Kubernetes), and cloud platforms (AWS/Azure)",
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Java Developer</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="mb-12">
          ...
          <p className="text-gray-400 leading-relaxed">
            We are looking for a skilled Java Developer to build robust, scalable enterprise applications for our clients and internal products. You will work with modern Java frameworks and cloud-native technologies to deliver high-quality solutions. This role involves designing microservices, building REST APIs, and working with databases in an agile environment where code quality and collaboration are paramount.
          </p>
        </div>
        ...
        <div className="text-center bg-zinc-900/50 border border-white/5 rounded-3xl p-10">
          ...
          <p className="text-gray-400 mb-6">Join our engineering team and build enterprise solutions at scale.</p>
