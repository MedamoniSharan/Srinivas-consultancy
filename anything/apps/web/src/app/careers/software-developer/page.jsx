...
const responsibilities = [
  "Develop full-stack web applications using React, Next.js on the frontend and Node.js/Express on the backend",
  "Participate in agile ceremonies including sprint planning, daily standups, and retrospectives to deliver features iteratively",
  "Conduct thorough code reviews to maintain code quality, share knowledge, and enforce best practices across the team",
  "Write comprehensive unit tests, integration tests, and end-to-end tests to ensure application reliability",
  "Design and implement RESTful APIs and GraphQL endpoints with proper authentication and authorization",
  "Collaborate with designers, product managers, and QA engineers to deliver polished, user-facing features",
];

const requirements = [
  "3+ years of experience in full-stack software development with modern JavaScript/TypeScript",
  "Strong proficiency in React (or Next.js) and Node.js with experience building production applications",
  "Solid understanding of relational and NoSQL databases (PostgreSQL, MongoDB, Redis)",
  "Experience with version control (Git), CI/CD pipelines, and cloud deployment (AWS, Vercel, or similar)",
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Software Developer</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="mb-12">
          ...
          <p className="text-gray-400 leading-relaxed">
            We&apos;re hiring a versatile Software Developer to join our engineering team and contribute to building modern web applications. You&apos;ll work across the full stack — from crafting responsive frontends with React to building scalable backend services with Node.js. In an agile environment, you&apos;ll participate in the entire software development lifecycle, from ideation and architecture to deployment and monitoring, while maintaining high standards through code reviews and testing.
          </p>
        </div>
        ...
        <div className="text-center bg-zinc-900/50 border border-white/5 rounded-3xl p-10">
          ...
          <p className="text-gray-400 mb-6">Join us and ship impactful software used by businesses worldwide.</p>
