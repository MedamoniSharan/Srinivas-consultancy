...
const responsibilities = [
  "Design, build, and maintain scalable ETL/ELT pipelines to ingest data from diverse sources into centralized data warehouses",
  "Architect and optimize data warehouse solutions using Snowflake, BigQuery, or Redshift for analytical workloads",
  "Implement real-time data processing systems using Apache Kafka, Spark Streaming, or Flink for event-driven architectures",
  "Manage and optimize data infrastructure on cloud platforms including AWS, GCP, and Azure",
  "Develop data quality frameworks with automated testing, monitoring, and alerting to ensure data integrity",
  "Collaborate with data scientists and analysts to build feature stores and serve curated datasets for ML models and reporting",
];

const requirements = [
  "3+ years of experience as a Data Engineer or in a similar data-focused role",
  "Strong proficiency in SQL, Python, and distributed data processing frameworks (Spark, Hadoop)",
  "Hands-on experience with cloud data services (AWS Glue, GCP Dataflow, Azure Data Factory)",
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Data Engineer</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="mb-12">
          ...
          <p className="text-gray-400 leading-relaxed">
            We&apos;re seeking a skilled Data Engineer to design and maintain the data infrastructure that powers our analytics, AI models, and business intelligence. You will work at the intersection of software engineering and data science, building reliable pipelines that transform raw data into actionable insights. This role offers the chance to work with cutting-edge data technologies and shape how our organization leverages data at scale.
          </p>
        </div>
        ...
        <div className="text-center bg-zinc-900/50 border border-white/5 rounded-3xl p-10">
          ...
          <p className="text-gray-400 mb-6">Join us in building the data infrastructure that drives innovation.</p>
