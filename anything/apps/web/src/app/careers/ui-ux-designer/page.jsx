...
const responsibilities = [
  "Conduct user research through interviews, surveys, and usability testing to deeply understand user needs and pain points",
  "Create wireframes, user flows, and interactive prototypes using Figma to communicate design concepts and interactions",
  "Build and maintain a comprehensive design system with reusable components, tokens, and documentation",
  "Translate complex requirements into intuitive, accessible, and visually compelling user interfaces",
  "Collaborate closely with product managers and developers to ensure design feasibility and pixel-perfect implementation",
  "Iterate on designs based on user feedback, analytics data, and A/B testing results to continuously improve UX",
];

const requirements = [
  "3+ years of experience in UI/UX design with a strong portfolio showcasing web and mobile projects",
  "Expert proficiency in Figma including auto-layout, components, variants, and prototyping",
  "Strong understanding of design principles, typography, color theory, and accessibility standards (WCAG)",
  "Experience with user research methodologies and data-driven design decision-making",
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">UI/UX Designer</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="mb-12">
          ...
          <p className="text-gray-400 leading-relaxed">
            We&apos;re looking for a creative and detail-oriented UI/UX Designer to shape the user experience across our products and client projects. You will lead the design process from research and ideation to high-fidelity prototypes and handoff. Working alongside product and engineering teams, you&apos;ll transform complex workflows into elegant, user-centered interfaces that delight users and drive business outcomes.
          </p>
        </div>
        ...
        <div className="text-center bg-zinc-900/50 border border-white/5 rounded-3xl p-10">
          ...
          <p className="text-gray-400 mb-6">Share your portfolio and help us create exceptional user experiences.</p>
