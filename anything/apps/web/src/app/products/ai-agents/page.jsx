...
const features = [
  {
    ...
    description: "Advanced NLP capabilities enable human-like conversations across channels. Our agents understand context, sentiment, and intent to deliver accurate, empathetic responses every time.",
  ...
  },
  {
    ...
    description: "Automate repetitive workflows around the clock without human intervention. From ticket routing to data entry, our agents handle it all so your team can focus on strategic work.",
    image: "https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?w=800&q=80&auto=format&fit=crop",
  },
  {
    icon: BarChart3,
    title: "Smart Analytics Dashboard",
    description: "Real-time insights into agent performance, conversation metrics, and customer satisfaction scores — all in one intuitive dashboard with exportable reports.",
    ...
    <PageLayout>
      ...
      <section className="relative pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <AnimatedSection>
            <span className="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-[#a855f7]/10 text-[#a855f7] border border-[#a855f7]/20 mb-6">AI Agents</span>
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-[1.1] mb-6">AI Agents</h1>
            <p className="text-lg text-zinc-400 leading-relaxed mb-8">
              Intelligent AI agents that automate business processes, handle customer interactions, and drive operational efficiency — all without human intervention.
            </p>
          ...
          <AnimatedSection delay={100}>
            <div className="rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(168,85,247,0.15)]">
              <img src="https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80&auto=format&fit=crop" alt="AI Agents" className="w-full h-full object-cover" />
            </div>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="px-6 pb-24 max-w-4xl mx-auto">
        <AnimatedSection>
          <div className="rounded-3xl bg-gradient-to-br from-[#7c3aed] to-[#a855f7] p-12 md:p-16 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Deploy Your First AI Agent Today</h2>
            <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">See how intelligent automation can transform your customer experience and operations.</p>
