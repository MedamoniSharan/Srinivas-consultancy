import { ArrowUpRight, Bot, Brain, Globe, Check, Smartphone, Code } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Advanced NLP capabilities that understand context, intent, and sentiment to deliver human-like conversations and accurate responses.",
    },
    {
      icon: <Code size={22} />,
      title: "Task Automation",
      desc: "Automate repetitive workflows and complex multi-step processes, freeing your team to focus on high-value strategic work.",
    },
    {
      icon: <Bot size={22} />,
      title: "Smart Routing",
      desc: "Intelligent routing that directs queries to the right department or agent based on topic, urgency, and customer history.",
    },
    {
      icon: <Check size={22} />,
      title: "24/7 Availability",
      desc: "Always-on agents that handle customer inquiries around the clock — no downtime, no delays, no missed opportunities.",
    },
    {
      icon: <Smartphone size={22} />,
      title: "Multi-channel Support",
      desc: "Deploy agents across web, mobile, email, chat, and social media for a unified experience on every channel.",
    },
    {
      icon: <Globe size={22} />,
      title: "Analytics Dashboard",
      desc: "Real-time dashboards with conversation metrics, resolution rates, and actionable insights to continuously improve performance.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">AI Agents</h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's discuss how AI agents can transform your business operations."}</p>
