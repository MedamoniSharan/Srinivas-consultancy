import { ArrowUpRight, Building2, Briefcase, Users, Globe, Check, Brain } from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Complete financial suite — general ledger, accounts payable/receivable, budgeting, and real-time financial reporting.",
    },
    {
      icon: <Users size={22} />,
      title: "HR Module",
      desc: "Manage the full employee lifecycle from recruitment to retirement — payroll, attendance, performance reviews, and benefits.",
    },
    {
      icon: <Building2 size={22} />,
      title: "Inventory Control",
      desc: "Real-time inventory tracking with automated reorder points, warehouse management, and multi-location support.",
    },
    {
      icon: <Globe size={22} />,
      title: "Supply Chain",
      desc: "End-to-end supply chain visibility from procurement to delivery, with demand forecasting and logistics optimization.",
    },
    {
      icon: <Brain size={22} />,
      title: "Business Intelligence",
      desc: "Powerful BI dashboards that transform raw data into actionable insights with custom reports and predictive analytics.",
    },
    {
      icon: <Check size={22} />,
      title: "Compliance",
      desc: "Built-in compliance frameworks for regulatory requirements, audit trails, and automated policy enforcement.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a855f7] selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">ERP System</h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          A unified enterprise resource planning system that connects finance, HR, inventory, and operations into one seamless, intelligent platform.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] border border-white/5 p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto mb-8">{"Let's discuss how our ERP system can unify your operations."}</p>
