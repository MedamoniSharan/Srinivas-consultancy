...
const CTA = () => {
  return (
    <section className="py-24 px-6">
      <AnimatedSection>
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-[2.5rem] border border-white/10 p-12 md:p-20 text-center relative overflow-hidden">
