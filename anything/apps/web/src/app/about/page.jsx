          ...
          {[
            {
              icon: <Users size={28} />,
              title: "Who We Are",
              desc: "Srinivas Consultancy is a technology solutions company specializing in AI products, IT staffing, and custom software development. We partner with businesses across industries to deliver intelligent, scalable solutions that create lasting impact.",
            },
            {
              icon: <Eye size={28} />,
              title: "Our Vision",
