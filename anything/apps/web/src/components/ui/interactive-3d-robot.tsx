...
/**
 * Spline + React.lazy are not safe during SSR; defer loading until after mount so
 * the server only renders the fallback (matches first client paint → no invalid element type).
 */
