    ...
    <footer className="border-t border-border/60">
      <div className="mx-auto max-w-7xl px-6 py-10 sm:py-12">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
          ...
          <nav
            className="grid min-w-0 flex-1 grid-cols-2 gap-x-10 gap-y-8 sm:grid-cols-3 sm:gap-x-12 lg:max-w-2xl lg:justify-items-stretch xl:max-w-none"
            aria-label="Footer"
          >
            <div>
              <h4 className="mb-3 text-base font-semibold text-foreground">Products</h4>
            ...
            <div>
              <h4 className="mb-3 text-base font-semibold text-foreground">Services</h4>
              <ul className="space-y-2.5 text-base text-muted-foreground">
                <li>
            ...
            <div className="col-span-2 sm:col-span-1">
              <h4 className="mb-3 text-base font-semibold text-foreground">Company</h4>
              <ul className="space-y-2.5 text-base text-muted-foreground">
                <li>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-3 border-t border-border/60 pt-6 text-sm text-muted-foreground sm:flex-row sm:items-center">
